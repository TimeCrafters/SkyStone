...
public class R2iRight extends SubEngine {

    private SkystoneSight skystoneSight;
    private Engine engine;
    private StateConfiguration stateConfiguration;

    public R2iRight(Engine engine, SkystoneSight skystoneSight, StateConfiguration stateConfiguration) {
        this.engine = engine;
    ...
    public void setProcesses() {
        ...
        addThreadedState(new DirectionDrive(engine, stateConfiguration, "R2i_R"));
    }
